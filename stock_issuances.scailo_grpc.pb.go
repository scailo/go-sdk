...
const (
	...
	StockIssuancesService_AttachVaultFolder_FullMethodName                         = "/Scailo.StockIssuancesService/AttachVaultFolder"
...
func (c *stockIssuancesServiceClient) AttachVaultFolder(ctx context.Context, in *VaultFolderAttachRequest, opts ...grpc.CallOption) (*IdentifierResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IdentifierResponse)
	err := c.cc.Invoke(ctx, StockIssuancesService_AttachVaultFolder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
