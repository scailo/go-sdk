...
const (
	...
	VAULT_PERMISSION_CODE_VAULT_PERMISSION_CODE_VIEW_UNSPECIFIED VAULT_PERMISSION_CODE = 0
	// Stores the bit weight of the meta permission (value is 2^1 = 2)
	VAULT_PERMISSION_CODE_VAULT_PERMISSION_CODE_META VAULT_PERMISSION_CODE = 1
	// Stores the bit weight of the download permission (value is 2^2 = 4)
	VAULT_PERMISSION_CODE_VAULT_PERMISSION_CODE_DOWNLOAD VAULT_PERMISSION_CODE = 2
	// Stores the bit weight of the add permission (value is 2^3 = 8)
	VAULT_PERMISSION_CODE_VAULT_PERMISSION_CODE_ADD VAULT_PERMISSION_CODE = 3
	// Stores the bit weight of the delete permission (value is 2^4 = 16)
	VAULT_PERMISSION_CODE_VAULT_PERMISSION_CODE_DELETE VAULT_PERMISSION_CODE = 4
	// Stores the bit weight of the execute permission (value is 2^5 = 32)
	VAULT_PERMISSION_CODE_VAULT_PERMISSION_CODE_EXECUTE VAULT_PERMISSION_CODE = 5
	// Stores the bit weight of all the available permissions (value is 2^6 = 64)
	VAULT_PERMISSION_CODE_VAULT_PERMISSION_CODE_ALL VAULT_PERMISSION_CODE = 20
)

// Enum value maps for VAULT_PERMISSION_CODE.
var (
	VAULT_PERMISSION_CODE_name = map[int32]string{
		0:  "VAULT_PERMISSION_CODE_VIEW_UNSPECIFIED",
		1:  "VAULT_PERMISSION_CODE_META",
		2:  "VAULT_PERMISSION_CODE_DOWNLOAD",
		3:  "VAULT_PERMISSION_CODE_ADD",
		4:  "VAULT_PERMISSION_CODE_DELETE",
		5:  "VAULT_PERMISSION_CODE_EXECUTE",
		20: "VAULT_PERMISSION_CODE_ALL",
	}
...
const file_vault_commons_scailo_proto_rawDesc = "" +
	...
	"\x14VAULT_REF_FOR_FOLDER\x10\x02*\x8a\x02\n" +
	"\x15VAULT_PERMISSION_CODE\x12*\n" +
	"&VAULT_PERMISSION_CODE_VIEW_UNSPECIFIED\x10\x00\x12\x1e\n" +
	"\x1aVAULT_PERMISSION_CODE_META\x10\x01\x12\"\n" +
	"\x1eVAULT_PERMISSION_CODE_DOWNLOAD\x10\x02\x12\x1d\n" +
	"\x19VAULT_PERMISSION_CODE_ADD\x10\x03\x12 \n" +
	"\x1cVAULT_PERMISSION_CODE_DELETE\x10\x04\x12!\n" +
	"\x1dVAULT_PERMISSION_CODE_EXECUTE\x10\x05\x12\x1d\n" +
	"\x19VAULT_PERMISSION_CODE_ALL\x10\x14*\x8b\x01\n" +
