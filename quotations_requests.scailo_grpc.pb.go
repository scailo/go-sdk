...
const (
	...
	QuotationsRequestsService_AttachVaultFolder_FullMethodName                            = "/Scailo.QuotationsRequestsService/AttachVaultFolder"
...
func (c *quotationsRequestsServiceClient) AttachVaultFolder(ctx context.Context, in *VaultFolderAttachRequest, opts ...grpc.CallOption) (*IdentifierResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IdentifierResponse)
	err := c.cc.Invoke(ctx, QuotationsRequestsService_AttachVaultFolder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
