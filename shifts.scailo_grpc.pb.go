...
const (
	...
	ShiftsService_AttachVaultFolder_FullMethodName    = "/Scailo.ShiftsService/AttachVaultFolder"
...
func (c *shiftsServiceClient) AttachVaultFolder(ctx context.Context, in *VaultFolderAttachRequest, opts ...grpc.CallOption) (*IdentifierResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(IdentifierResponse)
	err := c.cc.Invoke(ctx, ShiftsService_AttachVaultFolder_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
